...
静态注册实现方法参见 [Android Studio 配置 javah 生成 C/C++ 头文件，完成 JNI 调用](https://blog.csdn.net/Strange_Monkey/article/details/84028290) 中相关内容。
...
```
/**
* Java 层的 processFile 只有 3 个参数，而 JNI 中的方法有 5 中方法。
* JNIEnv *env 为 代表 JNI 环境的结构体
